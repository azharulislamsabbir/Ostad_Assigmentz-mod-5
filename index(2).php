...
<div class="container-fluid bg-info">
        <div class="row">
            <div class="col-md-12 mx-auto mt-5  vh-100">
                <div>
                    ...
                    <h3 class="text-center"> Php Laravel Batch-2</h3>
                    <div class="row text-center">
                        <div class="col-md-8 mx-auto mt-2 alert-danger">
                            <h2>Developed by Azharul Islam</h2><hr>
                        </div>
                    </div>
